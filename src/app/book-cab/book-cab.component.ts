...
export class BookCabComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (!this.sessionService.getSession()) {
      ...
      let respo = this.bookCabService.getAllDestinations();
      respo.subscribe(
        (data: any) => {
      ...
      let respoCab = this.bookCabService.getAllCabs();
      respoCab.subscribe(
        (data: any) => {
          this.allCabs = data;
  ...
  distancePirce() {
    let respo = this.bookCabService.getPrice(this.selectedSource, this.selectedDestination);
    respo.subscribe(
      (data: any) => {
    ...
    let respoDestination= this.bookCabService.getSelectedDestination(this.selectedSource, this.selectedDestination);
  ...
  calculatePrice() {
    ...
    let respo = this.bookCabService.findDrivers(this.selectedCab);
    respo.subscribe(
      (data: any) => {
